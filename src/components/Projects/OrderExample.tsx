...
export default function OrderExample() {
  ...
  return (
    <table className="min-w-full border-separate border-spacing-0">
      ...
      <tbody>
        <tr>
          <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-zinc-100 sm:pl-6 lg:pl-8">
            <div
          ...
          <td className="px-3 py-4 text-sm text-zinc-300">1</td>
          <td className="hidden whitespace-nowrap px-3 py-4 text-sm text-zinc-300 lg:table-cell">
            <div className="">Minilapper</div>
          </td>
          <td className="hidden whitespace-nowrap px-3 py-4 text-sm text-zinc-300 md:table-cell">
            1
          </td>
          <td className="hidden whitespace-nowrap px-3 py-4 text-sm text-zinc-300 md:table-cell">
            149
            ...
            <div className="flex w-28 items-center justify-center">
              ...
              {isProcessing && (
                <svg
                  ...
                  } aspect-square w-4 text-green-500`}
                >
